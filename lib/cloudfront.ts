...
export class CloudFrontStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: CloudFrontProps) {
    ...
    const s3Bucket = aws_s3.Bucket.fromBucketAttributes(
      this,
      `${props.stage}-${props.serviceName}-S3Bucket`,
      {
    ...
    interface WAFRule {
      ...
      overrideAction?: { none: Record<string, never> };
    ...
    putParam(
      'CfArn',
      `${prj}/CLOUDFRONT_DISTRIBUTION_ARN`,
