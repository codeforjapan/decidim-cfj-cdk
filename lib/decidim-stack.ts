    ...
    taskDefinition.addContainer('appContainer', {
      ...
      environment: {
        ...DecidimContainerEnvironment, ...{
          NEW_RELIC_AGENT_ENABLED: props.stage === 'prd-v0264' ? 'true' : 'false',
          NEW_RELIC_LICENSE_KEY: props.stage === 'prd-v0264' ? ssm.StringParameter.valueForTypedStringParameterV2(this, `/decidim-cfj/${ props.stage }/NEW_RELIC_LICENSE_KEY`) : '',
